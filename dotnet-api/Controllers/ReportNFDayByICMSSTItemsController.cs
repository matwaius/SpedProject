...
namespace dotnet_api.Controllers
{
    ...
    [ApiController]
    public class ReportNFDayByICMSSTItemsController : ControllerBase
    {
        private readonly IFilesRepository _repository;
        private readonly IMapper _mapper;
        private IConfiguration _configuration { get; }
        public ReportNFDayByICMSSTItemsController(IFilesRepository repository, IMapper mapper, IConfiguration configuration)
        {
        ...
        public async Task<IActionResult> Post([FromQuery] DateTime date, [FromQuery] Int16 indOperacao)
        {
            ...
            try
            {
                ...
                {
                    retRel = JsonConvert.SerializeObject(list.Where(w => w.VL_ICMS_ST > 0));
                }
            }
            catch
            {
