...
namespace dotnet_api.Controllers
{
    ...
    [ApiController]
    public class ReportNFDayItemsByUFController : ControllerBase
    {
        private readonly IFilesRepository _repository;
        private readonly IMapper _mapper;
        private IConfiguration _configuration { get; }
        public ReportNFDayItemsByUFController(IFilesRepository repository, IMapper mapper, IConfiguration configuration)
        {
        ...
        [HttpPost()]
        public async Task<IActionResult> Post([FromQuery] DateTime dateStart, [FromQuery] DateTime dateEnd, [FromQuery] string UF, [FromQuery] Int16 indOperacao, [FromQuery] string mod, [FromQuery] Int64 doc)
        {
            string retRel = "";
            try
            {
