...
export default {
  ...
  methods: {
    ...
    FilterBKP () {/*OK - Sem o moment para corrigir a data que está vindo datetime do backend */
      axios
        .post('https://localhost:7258/api/ReportNFQtdDayByUF?dateStart=' + this.date + '&dateEnd=' + this.date2).then(response => {
