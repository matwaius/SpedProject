    ...
    <v-row justify="end">
      <v-col cols="8" sm="0" md="8" class="filter">
        ...
        >
          ...
          />
          <path
            id="a14ee49e-0bc4-4fe7-9ff0-205b8984b39e-287"
          ...
          <rect
            ...
            fill="#3f3d56"
          />
          <circle cx="433.68729" cy="130.29436" r="6.35126" fill="#1976d2" />
          <circle cx="372.40295" cy="167.55074" r="6.35126" fill="#1976d2" />
          <circle cx="495.97165" cy="226.13194" r="6.35126" fill="#1976d2" />
          <path
            id="a2bcaba5-fcc7-43c7-8c54-c107139343be-288"
          ...
          />
          <path
            id="b02c718b-b277-4e02-ad4f-2608dd9924ba-289"
          ...
          />
          <path
            id="a6f13ee1-90c9-41e9-aa52-bae832a2d909-290"
          ...
          />
          <path
            id="fa174473-4e9f-4d8b-98c3-8d6761a9e9bb-291"
          ...
          />
          <path
            id="e966b75a-f3f6-4a21-bd4c-c130f0d0c74e-292"
          ...
          <path
            ...
            fill="#cacaca"
          />
          <circle cx="247.11862" cy="253.9035" r="6.35126" fill="#1976d2" />
          <circle cx="309.11862" cy="218.9035" r="6.35126" fill="#1976d2" />
        </svg>
      </v-col>
          ...
          <v-form ref="form" v-model="valid" lazy-validation>
            ...
            <v-col cols="12">
              <v-row justify="space-between">
                ...
                <v-btn color="primary" @click="getUser">Entrar</v-btn>
              </v-row>
            </v-col>
          </v-form>
        </v-card-text>
...
export default {
  ...
  methods: {
    async getUser() {
      ...
      await api.post(`/Signin?User=${this.formData.User}&Password=${encryptedPassword}`).then((response) => {
